...
class Settings {
	...
	public static $defaults = [
		...
		'snap_scrolling_offset_method' => 'scroll-padding',
		'smooth_scrolling' => false,
		'fill_on_scroll' => false,
		'highlight_active_nav' => false,
		'highlight_active_nav_default_style' => true,
		'skip_homepage' => false,
		'skip_homepage_showonce' => false,
		'skip_homepage_target' => '',
		'random_tagline' => false,
		'random_tagline_body_only' => true,
		'random_tagline_list' => '',
	...
	public function register_settings() {
		$schema = [
			...
			'properties' => [
				...
				'snap_scrolling_offset_method' => ['type' => 'string', 'enum' => ['none', 'scroll-padding', 'section-padding']],
				'smooth_scrolling' => ['type' => 'boolean'],
				'fill_on_scroll' => ['type' => 'boolean'],
				'highlight_active_nav' => ['type' => 'boolean'],
				'highlight_active_nav_default_style' => ['type' => 'boolean'],
				'skip_homepage' => ['type' => 'boolean'],
				'skip_homepage_showonce' => ['type' => 'boolean'],
				'skip_homepage_target' => ['type' => 'string'],
				'random_tagline' => ['type' => 'boolean'],
				'random_tagline_body_only' => ['type' => 'boolean'],
